...
<body>
    ...
    <div class="navbar">
        ...
        <input type="text" name="mailuser" class="loginInputField" placeholder="Username/E-mail..." autocomplete="off">
        <input type="password" name="pwd" class="loginInputField" placeholder="Password..." autocomplete="off">
